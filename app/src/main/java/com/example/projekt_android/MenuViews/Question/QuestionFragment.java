...
import com.example.projekt_android.constans.ValidationApi;
...
public class QuestionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.single_question_anonymous, container, false);
...
//                        lblresponse.setText(response.body().toString());
    ...
    private boolean validationContentQuestionForm() {
        ...
        if (nameAndSurname != null && email != null && topic != null && message != null && Validation.isValidEmail(charSequence)) {
            return true;
        }
        return false;
